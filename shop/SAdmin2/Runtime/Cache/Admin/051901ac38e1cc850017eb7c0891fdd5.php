                                ...
                                <!-- 工具栏按钮 -->
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                           ...
                                           <form action="<?php echo U('qingkong');?>" method="post" class="form-horizontal form form-builder form-builderf" style="margin-bottom:0px">
                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            <td>
                                                                <input class="tables" type="checkbox" value="<?php echo ($data['name']); ?>" name="tables[]">
                                                            </td>
                                                            <td><?php echo ($data['name']); ?></td>
                                                            <td><?php echo ($data['rows']); ?></td>
                                                            <td><?php echo (byte_Format($data['data_length'])); ?></td>
                                                            <td><?php echo ($data['create_time']); ?></td>
                                                            <td>
                                                               
                                                                <a name="edit" title="优化表" class="label label-primary-outline label-pill ajax-get confirm" href="<?php echo U('optimize',array('tables'=>$data['name']));?>">优化表</a>

                                 
                                                                <a name="forbid" title="修复表" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo U('repair',array('tables'=>$data['name']));?>">修复表</a>
