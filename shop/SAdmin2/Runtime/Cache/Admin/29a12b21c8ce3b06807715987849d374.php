                            ...
                            <div class="col-xs-12" >
                                ...
                                <div class="form-type-list">
                                   ...
                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">注册赠送积分数：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="jifen" class="form-control" value="<?php echo ($jifen); ?>" >
                                    ...
                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                       ...
                                       <label class="left control-label">奖励开关：</label>
                                        <div class="right">
                                            <div class="radio-inline cui-control cui-radio">
                                                <label for="config[ADMIN_TABS]0">
                                                    <input type="radio" id="config[ADMIN_TABS]0" class="radio" name="regjifen" value="0" <?php if(($regjifen) == "0"): ?>checked="true"<?php endif; ?> > 
                                            ...
                                            <div class="radio-inline cui-control cui-radio">
                                                    <label for="config[ADMIN_TABS]1">
                                                        <input type="radio" id="config[ADMIN_TABS]1" class="radio" name="regjifen" value="1" <?php if(($regjifen) == "1"): ?>checked="true"<?php endif; ?> > 
                                                        <span class="cui-control-indicator"></span>
                                                        <span>开启</span>
                                                    </label>
                                            </div>        
...
推荐奖励设置<hr style="margin-top: 0px;width: 100%">



                         <form action="<?php echo U('Config/tuijian');?>" method="post" class="form-horizontal form form-builder ssss1">
                                <div class="form-type-list">

                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">推荐一个人赠送积分数：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="jifens" class="form-control" value="<?php echo ($jifens); ?>" >
                                         
                                        </div>
                                    </div>
                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">赠送积分最大推荐人数：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="rens" class="form-control" value="<?php echo ($rens); ?>" >
                                ...
                                <div class="form-group"></div>
                                <div class="form-group bottom_button_list">
                                    <a class="btn btn-primary submit ajax-post" type="submit" target-form="ssss1">确定</a>
                                    <a class="btn btn-danger return" onclick="javascript:history.back(-1);return false;">取消</a>
                                </div>
                            </div>
                        </form>
