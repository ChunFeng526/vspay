                ...
                <div class="builder formbuilder-box">
                        <div class="builder-tabs builder-form-tabs">
	                        <ul class="nav nav-tabs">
	                             <li>
	                                <a href="<?php echo U('Database/index');?>">备份数据</a>
	                            </li>
	                            <li class="active">
	                                <a href="<?php echo U('Database/import');?>">还原数据</a>
	                            </li>
	                        </ul>
	                    </div>
                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><?php echo (byte_Format($data['fileinfo']['size'])); ?></td>
                                                            <td><?php echo (date("Y-m-d H:i:s",$data['fileinfo']['ctime'])); ?></td>
                                                            <td>
                                                                <a title="下载" class="label label-primary-outline label-pill" href="<?php echo U('download',array('filename'=>$data['filename']));?>">下载</a>

                                                                <a title="删除" class="abel label-danger-outline label-pill ajax-get confirm" href="<?php echo U('del',array('filename'=>$data['filename']));?>">删除</a>
