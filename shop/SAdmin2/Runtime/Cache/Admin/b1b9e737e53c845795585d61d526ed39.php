                            ...
                            <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            <a title="删除" target-form="ids" class="btn btn-danger-outline btn-pill ajax-post confirm" model="User" href="<?php echo U('Traing/setStatus',array('status'=>delete,'model'=>growth));?>">删除</a>&nbsp;                   
                                        </div>
                                    </div>
                                    <!-- 搜索框 -->
                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><?php echo ($data['shifei_num']+0); ?></td>
                                                            <td><?php echo (get_user_name($data['uid'])); ?></td>
                                                            <td><?php echo (date('Y-m-d :H:i:s',$data['shifei_time'])); ?></td>
                                                            <td>
                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="User" href="<?php echo U('Traing/setStatus',array('status'=>delete,'ids'=>$data['id'],'model'=>'growth'));?>">删除</a>
                                                            </td>
