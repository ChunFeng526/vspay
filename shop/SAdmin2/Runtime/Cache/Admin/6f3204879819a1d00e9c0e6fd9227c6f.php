...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted"><?php if (ACTION_NAME=='index') { echo "定向交易"; }else{ echo "自由交易"; } ?></li>
                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            <td><?php echo ($data['num']+$data['fee_num']); ?></td>
                                                            <td><?php echo ($data['num']); ?></td>
                                                            <td><?php echo ($data['fee_num']+0); ?></td>
                                                            <td><?php echo ($data['sell_username']); ?></td>
                                                            <td><?php echo ($data['sell_account']); ?></td>
                                                            <td><?php echo ($data['buy_username']); ?></td>
                                                            <td><?php echo ($data['buy_account']); ?></td>
                                                            <td><?php echo (date('Y-m-d',$data['create_time'])); ?></td>
                                                            <td><?php echo (status_name('traing',$data["status"])); ?></td>
