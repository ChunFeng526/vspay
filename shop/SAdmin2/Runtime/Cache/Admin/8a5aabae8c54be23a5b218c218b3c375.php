                                ...
                                <!-- 工具栏按钮 -->
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            ...
                                            <a title="启用" target-form="ids" class="btn btn-success-outline btn-pill ajax-post confirm" model="User" href="<?php echo U('User/setStatus',array('status'=>resume,'model'=>User));?>">启用</a>&nbsp;
                                            <a title="禁用" target-form="ids" class="btn btn-warning-outline btn-pill ajax-post confirm" model="User" href="<?php echo U('User/setStatus',array('status'=>forbid,'model'=>User));?>">禁用</a>&nbsp;
                                            <a title="删除" target-form="ids" class="btn btn-danger-outline btn-pill ajax-post confirm" model="User" href="<?php echo U('User/setStatus',array('status'=>delete,'model'=>User));?>">删除</a>&nbsp;                   
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php else: ?>
                                                                <a name="edit" title="编辑" class="label label-primary-outline label-pill" href="<?php echo U('User/edit',array('id'=>$data['id']));?>">编辑</a>

                                                                <?php if(($data['status']) == "1"): ?><a name="forbid" title="禁用" class="label label-warning-outline label-pill ajax-get confirm" href="<?php echo U('User/setStatus',array('status'=>forbid,'ids'=>$data['id'],'model'=>'User'));?>">禁用</a>
                                                                <?php else: ?>
                                                                <a name="forbid" title="启用" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo U('User/setStatus',array('status'=>resume,'ids'=>$data['id'],'model'=>'User'));?>">启用</a><?php endif; ?>

                                                                <a name="delete" title="回收" class="label label-danger-outline label-pill ajax-get confirm" model="User" href="<?php echo U('User/setStatus',array('status'=>recycle,'ids'=>$data['id'],'model'=>'User'));?>">回收</a><?php endif; ?>
