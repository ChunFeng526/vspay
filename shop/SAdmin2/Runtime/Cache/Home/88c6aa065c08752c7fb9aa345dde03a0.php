...
<div class="header">
     <div class="userInfo" style="width: 75%">
    	...
    	<div class="uid_xy">
    		...
    		<p><?php echo (L("credit")); ?>
			<?php $__FOR_START_12726__=0;$__FOR_END_12726__=$uinfo['user_credit'];for($i=$__FOR_START_12726__;$i < $__FOR_END_12726__;$i+=1){ ?><span><img src="/Public/home/wap/images/aix-icon.png"></span><?php } ?>
			</p>
    	</div>	
    </div>
