...
<body class="bg96">
	<div class="header">
	    ...
	    <div class="header_c"><h2><?php echo (L("gbzc")); ?></h2></div>
       ...
       <div class="big_width200">
         <div class="fill_sty">
          <p style="width:100%;color: #666;"><?php echo (L("dqgbkyzc")); ?>:<span style="margin-left:0.3rem;font-weight: bold;color: #333;"><?php echo ($mwenums); ?></span></p>
