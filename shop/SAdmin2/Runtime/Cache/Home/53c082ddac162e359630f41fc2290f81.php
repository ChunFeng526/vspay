...
<body class="bg96">
	<div class="header">
	    ...
	    <div class="header_c"><h2>C宝锁定资产</h2></div>
       ...
       <div class="big_width200">
         <div class="fill_sty">
          <p style="width:100%;color: #666;">当前C宝可用资产:<span style="margin-left:0.3rem;font-weight: bold;color: #333;"><?php echo ($mwenums); ?></span></p>
    
         </div>
          <div class="fill_sty">
          <p>锁定数量</p>
            <input type="text" name="num" class="paynums" placeholder="可输入最多四位小数" autocomplete="off">
         </div>
