...
<style>
 /* #highcharts-ndegtvt-0{height: 180px !important}*/
</style>
<body class="bg96">
 ...
 $arr=array(1=>"",2=>"比特币",3=>"莱特币",4=>"以太坊",5=>"狗狗币"); ?>
	    <div class="header_c" id="dig_xiala"><h2  style="line-height:36px;"><?php echo ($arr[$cid]); ?></h2> <p id="a"></p>
            <div id="dig_xiala_xs">
             <div class="downa">
	             <ul>
	            	<li><a href="<?php echo U('Turntable/Transaction',array('cid'=>1));?>"></a></li>
	            	<li><a href="<?php echo U('Turntable/Transaction',array('cid'=>2));?>">比特币</a></li>
	            	<li><a href="<?php echo U('Turntable/Transaction',array('cid'=>3));?>">菜特币</a></li>
	            	<li><a href="<?php echo U('Turntable/Transaction',array('cid'=>4));?>">以太坊</a></li>
	            	<li class="off"><a href="<?php echo U('Turntable/Transaction',array('cid'=>5));?>">狗狗币</a></li>
	            </ul>
            </div>
    ...
    <div class="big_width100">
     ...
     <div class="buy_inde_dangq">
     	<ul class="clear_wl">
     		<li> <p><span><?php echo (L("nowprice")); ?></span><?php echo ($coindets['coin_price']); ?></p></li>
     		<li> <p><span><?php echo (L("gao")); ?></span><?php echo ($coindets['max']); ?> <img src="/Public/home/wap/images/buy_bie.png"></p></li>
     		<li> <p><span><?php echo (L("di")); ?></span><?php echo ($coindets['min']); ?> <img src="/Public/home/wap/images/buy_jiang.png"></p></li>
     	</ul>
     </div>
...
<div id="container1"  style="width:100%; height: 14rem; margin: 0 auto;margin-left:0rem;margin-top:0.5rem;margin-bottom:1.9rem;"></div>
<div id="container2"  style="display:none;width:100%; height: 14rem; margin: 0 auto;margin-left:0rem;margin-top:0.5rem;margin-bottom:1.9rem;"></div>
<div id="container3"  style="display:none;width:100%; height: 14rem; margin: 0 auto;margin-left:0rem;margin-top:0.5rem;margin-bottom:1.9rem;"></div> -->
    

 <div class="buy_quexiant">
			   
			   <ul class="clear_wl">
			   	  <li id="s1" onclick="cont1();" class="yon"><?php echo (L("yixs")); ?></li>
			   	  <li id="s2"  onclick="cont2();" class=""><?php echo (L("wuxs")); ?></li>
			   	  <li id="s3"  onclick="cont3();" class=""><?php echo (L("tian")); ?></li>
			   </ul>
...
$('highcharts-background').css('height','20vmin');
    ...
    <div  class="on"> <a href="<?php echo U('Turntable/Transaction',array('cid'=>$cid));?>">购买</a></div>
	    <div><a href="<?php echo U('Turntable/Transactionsell',array('cid'=>$cid));?>">出售</a></div>
	       ...
	       <ul class="buy_gaomai">
	       	 ...
	       	 <?php if(is_array($deals)): foreach($deals as $k=>$v): ?><li>
	       	 	...
	       	 	<div class="buy_li_gor">
	       	 		...
	       	 		<a href="javascript:void(0);" class="ljzf_but " onclick="gbzhi(<?php echo ($v['d_num']); ?>,<?php echo ($v['d_dprice']); ?>,'<?php echo ($v['u_name']); ?>',<?php echo ($v['d_id']); ?>)">购买</a>
	       	 	</div>
		        ...
		        <div class="srzfmm_box">
		            <div class="qsrzfmm_bt clear_wl">
		               ...
		               <input type="hidden" id="dealid">
		                <span class="fl goumaiduix">向[情动之初]购买<br/>Wpeay</span></div>
 ...
 obj.value = obj.value.replace(/^(\-)*(\d+)\.(\d\d\d\d).*$/,'$1$2.$3');//只能输入三个小数.(\d\d\d) 修改个数  加\d
	...
	function gbzhi(s1,s2,s3,s4) 
			{ 
				...
				$(".limit").text(s1);
				$(".goumaiduix").html("向["+s3+"]购买<br><?php echo ($coindets['coin_name']); ?>");
				$("#dprice").val(s2);	
				$("#dealid").val(s4);	
