...
<body class="bg96">
	...
	<div class="header">
	    ...
	    <div class="header_r"><a href="<?php echo U('Turntable/Trans');?>"><?php echo (L("jl")); ?></a></div>
	</div>

       <div class="big_width100">
	       <div class="fill_sty">
	       	<p></p>
	       		<input type="text" name="other_account" class="paynums" placeholder="<?php echo (L("zhuannum")); ?>" autocomplete="off" >
	       </div>
	        <div class="fill_sty">
	       	<p><?php echo (L("outadd")); ?></p>
	       		<input type="text" name="other_account" class="moneyadd" placeholder="<?php echo (L("mobile")); ?>/UID/<?php echo (L("qianbao")); ?>" autocomplete="off">
	       </div>
		   ...
		   <div class="ftc_wzsf" >
			   <div class="srzfmm_box">
				   ...
				   <div class="zfmmxx_shop">
					   <div class="mz"><?php echo (L("xiang")); ?>（<?php echo ($uinfo['username']); ?>）<?php echo (L("pay1")); ?></div>
	...
	<script type="text/javascript">
        $('#operConfirm').on('click', function(){
			...
			if(moneyadd == ''){
			    msg_alert('请输入手机或者uid或者钱包地址');
			}
			$.ajax({
				url:'/Turntable/Checkuser',
				type:'post',
