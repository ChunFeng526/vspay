...
<div class="member-top">
    ...
    <div class="member-info">
        ...
        <div class="user-name">
            <?php if(($member['status']) == 0 ): ?><span style="left:35%;"><?php echo ($member['username']); ?>
                    <a href="<?php echo U('Shop/Member/verify');?>"><sup>升级商家</sup></a>
            </span>
                <?php else: ?>
                <span style="left:0%;"><?php echo ($member['username']); ?>
                </span><?php endif; ?>
        </div>
    </div>
</div>
<div class="user-order-box">
    <dl><a href="<?php echo U('Member/allorder',array('s'=>dede));?>">
    ...
    <ul>
        ...
        <li><a href="<?php echo U('Member/allorder',array('s'=>2));?>">
            <div class="user_order"><i class="iconfont">&#xe775;</i></div>
            <span>待收货</span> </a></li>
        <!-- <li>    <a href="<?php echo U('Member/allorder',array('s'=>3));?>">        <div class="user_order">            <i class="iconfont">&#xe663;</i>        </div>        <span>待评价</span>    </a></li> -->
...
<div class="uset-center-content">
    <!--     <a href="<?php echo U('Member/collection');?>">    <em class="goods-collection-icon"></em>    <dl>        <dt>我的收藏</dt>        <dd>商品收藏/店铺收藏</dd>    </dl></a> -->
    <!--<a href="">-->    <!--<em class="groupon-icon"></em>-->    <!--<dl>-->    <!--<dt>我的拼团</dt>-->
    <!--<dd></dd>-->    <!--</dl>-->    <!--</a>-->     <!-- <a href="<?php echo U('Member/myAward');?>"> -->
    <!--<a href="###">-->        <!--<em class="exchange-icon"></em>-->        <!--<dl>-->
    <!--<dt>我的奖金</dt>-->            <!--<dd></dd>-->        <!--</dl>-->    <!--</a>--> <a
        href="<?php echo U('Member/moneydets');?>"> <em class="exchange-icon"></em>
    <dl>
        <dt>商城收益</dt>
        <dd></dd>
    </dl>
</a>    <!--<a href="<?php echo U('Member/Tixiandecors');?>">-->        <!--<em class="bargain-icon"></em>-->        <!--<dl>-->
    <!--<dt>提现记录</dt>-->            <!--<dd></dd>-->        <!--</dl>-->    <!--</a>-->    <!----> <a
...
</a>    <!--<a href="">-->    <!--<em class="review-icon"></em>-->    <!--<dl class="border_bottm">-->
    <!--<dt>评价/晒单</dt>-->    <!--<dd>查看评价/晒单</dd>-->    <!--</dl>-->    <!--</a>-->
    <!--<a href="<?php echo U('Member/Personal');?>">-->        <!--<em class="user-info-icon"></em>-->        <!--<dl>-->
    <!--<dt>个人资料</dt>-->            <!--<dd>查看/修改</dd>-->        <!--</dl>-->    <!--</a>--><a
...
</div><!--<div class="uset-center-content">--><!--<a href="">--><!--<em class="btn-popularize-icon"></em>--><!--<dl>-->
<!--<dt>我的推广</dt>--><!--<dd></dd>--><!--</dl>--><!--</a>--><!--<a href="">--><!--<em class="btn-recommend-icon"></em>-->
<!--<dl>--><!--<dt>我的推荐</dt>--><!--<dd></dd>--><!--</dl>--><!--</a>--><!--<a href="">-->
<!--<em class="btn-distribution-icon"></em>--><!--<dl>--><!--<dt>申请合伙人12</dt>--><!--<dd></dd>--><!--</dl>--><!--</a>-->
<!--</div>--><!--<div class="uset-center-content">--><!--<a href="">--><!--<em class="btn-shop-apply-icon"></em>-->
<!--<dl>--><!--<dt>商家入驻</dt>--><!--</dl>--><!--</a>--><!--<a href="">--><!--<em class="btn-recommend-shop-icon"></em>-->
<!--<dl>--><!--<dt>推荐店铺</dt>--><!--</dl>--><!--</a>--><!--</div>-->
