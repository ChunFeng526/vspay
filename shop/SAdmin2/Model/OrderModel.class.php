...
class OrderModel{
	...
	public function show_order_page($search){
		...
		$sql="SELECT o.order_id,o.order_no,o.uid,m.uname,m.phone,o.status,o.time,o.buy_price,o.buy_name,o.buy_phone,o.seluid FROM "
		.C('DB_PREFIX').'order o,'.C('DB_PREFIX').'member m WHERE o.uid=m.member_id ';
