...
<html lang="en">
  ...
  <div class="table-responsive">
                <div class="page-header">
                    <a class="btn btn-primary" href='<?php echo U("Settings/zhang");?>'>新增</a>
                </div>
 ...
 <td>
     <a class="delete btn btn-xs btn-danger"
        href='<?php echo U("Settings/dltwentype",array("id"=>$v["id"]));?>'>
         <i class="icon-trash bigger-120"></i>
     </a>
 
     <a class="btn btn-xs btn-info" href='<?php echo U("Settings/zhang",array("id"=>$v["id"]));?>'>编辑</a>
