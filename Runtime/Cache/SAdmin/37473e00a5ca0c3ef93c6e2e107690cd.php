...
<div class="row">
	<div class="col-xs-12">	
		<form class="form-horizontal"  id="form" method="post" action="<?php echo U('Settings/msgs');?>">	
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="MSG" class="col-xs-10 col-sm-10 form-control" readonly="readonly" value="<?php echo ((isset($content) && ($content !== ""))?($content):''); ?>" type="text">
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="MSG_account" class="col-xs-10 col-sm-10 form-control"  value="<?php echo ((isset($account) && ($account !== ""))?($account):''); ?>" type="text">
				</div>
			</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input name="MSG_password" class="col-xs-10 col-sm-10 form-control"  value="<?php echo ((isset($password) && ($password !== ""))?($password):''); ?>" type="text">
				</div>
			</div>
			</div>
