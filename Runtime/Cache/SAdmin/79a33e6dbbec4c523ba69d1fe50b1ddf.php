        ...
        <div class="col-xs-12">
            <div class="table-responsive">
                <div class="page-header">
                    <a class="btn btn-primary" href='<?php echo U("Settings/Detnotice");?>'>新增</a>
                </div>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><?php echo ($v["notice_tittle"]); ?></td>
                            <td>
                                <?php echo date('Y-m-d H:i:s',$v['notice_addtime']); ?>
                            </td>

                            <!--<td>-->

                            <!--<?php if(($v['all_state']) == "1"): ?>-->
                            <!--<a class="btn btn-xs passed passed" style="background: #00c4c5 !important;border-color:#00c4c5" href="javascript:void(0)">-->
                            <!--已取消-->
                            <!--</a>-->
                            <!--<?php endif; ?>-->

                            <!--<?php if(($v['all_state']) == "2"): ?>-->
                            <!--<a class="btn btn-xs passed passed" style="background: #00c4c5 !important;border-color:#00c4c5" href="javascript:void(0)">-->
                            <!--已完成-->
                            <!--</a>-->
                            <!--<?php endif; ?>-->

                            <!--<?php if(($v['all_state']) == "0"): ?>-->
                            <!--<a class="btn btn-xs passed passed" style="background: #00c4c5 !important;border-color:#00c4c5" href="javascript:void(0)">-->
                            <!--进行中-->
                            <!--</a>-->
                            <!--<?php endif; ?>-->
                            ...
                            <td>
                                <a class="delete btn btn-xs btn-danger"
                                   href='<?php echo U("Settings/del",array("id"=>$v["id"]));?>'>
                                    <i class="icon-trash bigger-120"></i>
                                </a>

                                <a class="btn btn-xs btn-info" href='<?php echo U("Settings/Detnotice",array("id"=>$v["id"]));?>'>编辑</a>
