...
<html lang="en">
    ...
    <div class="row">
        <div class="col-xs-12">
            <form class="form-horizontal" id="form" method="post" action="<?php echo U('Settings/Savenotice');?>">
                <div class="form-group">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 公告标题 </label>
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="notice_tittle" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["notice_tittle"]) && ($msgll["notice_tittle"] !== ""))?($msgll["notice_tittle"]):''); ?>" type="text">
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 公告详情 </label>
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <textarea name="notice_content" id="input-meta-description2" class="form-control"
                                          rows="5"><?php echo ((isset($msgll["notice_content"]) && ($msgll["notice_content"] !== ""))?($msgll["notice_content"]):''); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
