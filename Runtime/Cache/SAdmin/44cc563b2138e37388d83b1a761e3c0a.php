...
<html lang="en">
    ...
    <div class="row">
        <div class="col-xs-12">
            <form class="form-horizontal" id="form" method="post" action="<?php echo U('Settings/Savewen');?>">
...
<?php if(($msgll['tid'])): ?><option value="<?php echo ($msgll['tid']); ?>"><?php echo ($msgll['type']); ?></option>
<?php else: ?>
        <option value="">-选择分类-</option> 
        <?php if(is_array($ttle)): foreach($ttle as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" ><?php echo ($v['title']); ?></option><?php endforeach; endif; ?>
<!--         <option value="5" >帮助中心</option>
<option value="6" >商城介绍</option> --><?php endif; ?>
        </select>
...
<!-- 
 ...
 -->
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 文章标题 </label>
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="title" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["title"]) && ($msgll["title"] !== ""))?($msgll["title"]):''); ?>" type="text">
                            </div>

                            <input name="id" hidden value="<?php echo ($id); ?>" >
                        </div>
                    </div>
         <?php if(($msgll['tid'] == 5) ): ?><div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 视频链接一 </label>
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="linkone" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["linkone"]) && ($msgll["linkone"] !== ""))?($msgll["linkone"]):''); ?>" type="text">
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 视频链接二 </label>
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="linktwo" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["linktwo"]) && ($msgll["linktwo"] !== ""))?($msgll["linktwo"]):''); ?>" type="text">
                            </div>
          ...
          <?php else: endif; ?>
                ...
                <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-description">* 文章详情</label>
                        <div class="col-sm-10">
                          <textarea name="content" id="description"><?php echo ((isset($msgll["content"]) && ($msgll["content"] !== ""))?($msgll["content"]):''); ?></textarea>   
                        </div>
          </div>
