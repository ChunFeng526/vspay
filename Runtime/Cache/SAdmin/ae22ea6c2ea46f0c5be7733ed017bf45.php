  ...
  <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <?php if($v['level'] == 1): ?><td style="color:blue;">黄金会员</td>
                            ...
                            <td><?php echo ($v['money']); ?></td>
                             <td>
                                <a href="<?php echo ($v['proof']); ?>" target="_blank"><img width="60" height="40" src="<?php echo ($v['proof']); ?>"></a>
                            </td>
                            ...
                            <td><?php echo (date('Y-m-d H:i:s',$v['time'])); ?></td>
                             <td>
                                <?php if($v['status'] == 0): ?><a class="btn btn-xs btn-info" href='<?php echo U("Goods/levelup",array("id"=>$v["id"],"status"=>1));?>'>通过认证</a>
                                <a class="btn btn-xs btn-info" href='<?php echo U("Goods/levelup",array("id"=>$v["id"],"status"=>2));?>'>取消</a><?php endif; ?>
                            </td>
